...
public class LTLSpecParser extends Parser {
    ...
    public String getGrammarFileName() { return "LTLSpec.g"; }
    	...
    	public LTLSpecParser(TokenStream input, String annotatedClassName) {
          this(input);
          gSymbolicAtom.annotatedClass = annotatedClassName;
        }
    ...
    // $ANTLR start "ltlSpec"
    // LTLSpec.g:62:1: ltlSpec returns [Formula<String> f] : b= binaryFormula ;
    public final Formula<String> ltlSpec() throws RecognitionException {
        ...
        try {
            // LTLSpec.g:66:2: (b= binaryFormula )
            // LTLSpec.g:66:4: b= binaryFormula
            {
    ...
    // LTLSpec.g:69:1: unaryOperator returns [String operator] : ( NOT | NEXT | ALWAYS | EVENTUALLY );
    public final String unaryOperator() throws RecognitionException {
        String operator = null;

        try {
            // LTLSpec.g:70:2: ( NOT | NEXT | ALWAYS | EVENTUALLY )
            int alt1=4;
            switch ( input.LA(1) ) {
            case NOT:
                {
    ...
    // LTLSpec.g:76:1: binaryFormula returns [Formula<String> f] : l1= logicalFormula (i= IMPLIES l2= binaryFormula )? ;
    public final Formula<String> binaryFormula() throws RecognitionException {
        ...
        try {
            // LTLSpec.g:77:2: (l1= logicalFormula (i= IMPLIES l2= binaryFormula )? )
            // LTLSpec.g:77:4: l1= logicalFormula (i= IMPLIES l2= binaryFormula )?
            {
            ...
            // LTLSpec.g:78:2: (i= IMPLIES l2= binaryFormula )?
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // LTLSpec.g:78:3: i= IMPLIES l2= binaryFormula
                    {
    ...
    // LTLSpec.g:83:1: logicalFormula returns [Formula<String> f] : t1= andFormula ( ( OR | ROBBYJO_OR ) t2= logicalFormula )? ;
    public final Formula<String> logicalFormula() throws RecognitionException {
        ...
        try {
            // LTLSpec.g:84:2: (t1= andFormula ( ( OR | ROBBYJO_OR ) t2= logicalFormula )? )
            // LTLSpec.g:84:4: t1= andFormula ( ( OR | ROBBYJO_OR ) t2= logicalFormula )?
            {
            ...
            // LTLSpec.g:85:2: ( ( OR | ROBBYJO_OR ) t2= logicalFormula )?
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // LTLSpec.g:85:3: ( OR | ROBBYJO_OR ) t2= logicalFormula
                    {
    ...
    // LTLSpec.g:89:1: andFormula returns [Formula<String> f] : t1= temporalFormula ( ( AND | ROBBYJO_AND ) t2= andFormula )? ;
    public final Formula<String> andFormula() throws RecognitionException {
        ...
        try {
            // LTLSpec.g:90:2: (t1= temporalFormula ( ( AND | ROBBYJO_AND ) t2= andFormula )? )
            // LTLSpec.g:90:4: t1= temporalFormula ( ( AND | ROBBYJO_AND ) t2= andFormula )?
            {
            ...
            // LTLSpec.g:91:2: ( ( AND | ROBBYJO_AND ) t2= andFormula )?
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // LTLSpec.g:91:3: ( AND | ROBBYJO_AND ) t2= andFormula
                    {
    ...
    // LTLSpec.g:95:1: temporalFormula returns [Formula<String> f] : p1= releaseFormula ( UNTIL p2= temporalFormula | WEAK_UNTIL p3= temporalFormula )? ;
    public final Formula<String> temporalFormula() throws RecognitionException {
        ...
        try {
            // LTLSpec.g:96:2: (p1= releaseFormula ( UNTIL p2= temporalFormula | WEAK_UNTIL p3= temporalFormula )? )
            // LTLSpec.g:96:4: p1= releaseFormula ( UNTIL p2= temporalFormula | WEAK_UNTIL p3= temporalFormula )?
            {
            ...
            // LTLSpec.g:97:2: ( UNTIL p2= temporalFormula | WEAK_UNTIL p3= temporalFormula )?
            int alt5=3;
            ...
            switch (alt5) {
                case 1 :
                    // LTLSpec.g:97:4: UNTIL p2= temporalFormula
                    {
                    ...
                    break;
                case 2 :
                    // LTLSpec.g:98:4: WEAK_UNTIL p3= temporalFormula
                    {
    ...
    // LTLSpec.g:102:1: releaseFormula returns [Formula<String> f] : p1= proposition ( RELEASE p2= releaseFormula | WEAK_RELEASE p3= releaseFormula )? ;
    public final Formula<String> releaseFormula() throws RecognitionException {
        ...
        try {
            // LTLSpec.g:103:2: (p1= proposition ( RELEASE p2= releaseFormula | WEAK_RELEASE p3= releaseFormula )? )
            // LTLSpec.g:103:4: p1= proposition ( RELEASE p2= releaseFormula | WEAK_RELEASE p3= releaseFormula )?
            {
            ...
            // LTLSpec.g:104:2: ( RELEASE p2= releaseFormula | WEAK_RELEASE p3= releaseFormula )?
            int alt6=3;
            ...
            switch (alt6) {
                case 1 :
                    // LTLSpec.g:104:4: RELEASE p2= releaseFormula
                    {
                    ...
                    break;
                case 2 :
                    // LTLSpec.g:105:4: WEAK_RELEASE p3= releaseFormula
                    {
    ...
    // LTLSpec.g:109:1: proposition returns [Formula<String> f] : ( TRUE | FALSE | s= atom | u1= unaryOperator l3= proposition | '(' l4= ltlSpec ')' );
    public final Formula<String> proposition() throws RecognitionException {
        ...
        try {
            // LTLSpec.g:110:2: ( TRUE | FALSE | s= atom | u1= unaryOperator l3= proposition | '(' l4= ltlSpec ')' )
            int alt7=5;
            alt7 = dfa7.predict(input);
            switch (alt7) {
                case 1 :
                    // LTLSpec.g:110:4: TRUE
                    {
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // LTLSpec.g:113:4: u1= unaryOperator l3= proposition
                    {
    ...
    static final String DFA7_acceptS =
        "\1\uffff\1\1\1\2\1\3\16\uffff\1\4\3\uffff\1\5";
    static final String DFA7_specialS =
        "\15\uffff\1\0\11\uffff}>";
    static final String[] DFA7_transitionS = {
            "\1\3\1\22\2\3\3\22\11\3\1\1\1\2\17\uffff\1\15\1\uffff\3\3",
            "",
            "",
            "",
            "",
    ...
    class DFA7 extends DFA {
        ...
        public String getDescription() {
            return "109:1: proposition returns [Formula<String> f] : ( TRUE | FALSE | s= atom | u1= unaryOperator l3= proposition | '(' l4= ltlSpec ')' );";
        }
    ...
    public static final BitSet FOLLOW_IMPLIES_in_binaryFormula139 = new BitSet(new long[]{0x00000320003007F0L});
    ...
    public static final BitSet FOLLOW_set_in_logicalFormula187 = new BitSet(new long[]{0x00000320003007F0L});
    ...
    public static final BitSet FOLLOW_set_in_andFormula239 = new BitSet(new long[]{0x00000320003007F0L});
    ...
    public static final BitSet FOLLOW_UNTIL_in_temporalFormula295 = new BitSet(new long[]{0x00000320003007F0L});
    public static final BitSet FOLLOW_temporalFormula_in_temporalFormula299 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_WEAK_UNTIL_in_temporalFormula316 = new BitSet(new long[]{0x00000320003007F0L});
    ...
    public static final BitSet FOLLOW_RELEASE_in_releaseFormula363 = new BitSet(new long[]{0x00000320003007F0L});
    public static final BitSet FOLLOW_releaseFormula_in_releaseFormula367 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_WEAK_RELEASE_in_releaseFormula377 = new BitSet(new long[]{0x00000320003007F0L});
    ...
    public static final BitSet FOLLOW_unaryOperator_in_proposition473 = new BitSet(new long[]{0x00000320003007F0L});
    public static final BitSet FOLLOW_proposition_in_proposition477 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_37_in_proposition488 = new BitSet(new long[]{0x00000320003007F0L});
